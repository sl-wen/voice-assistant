...
class SoundBridge : Form
{
    ...
    void SetupWindow()
    {
        ...
        qrBox.Location = new Point(20, 96);
        qrBox.Size = new Size(120, 120);
        qrBox.BackColor = Color.White;
        qrBox.SizeMode = PictureBoxSizeMode.Zoom;
        qrBox.BorderStyle = BorderStyle.FixedSingle;
        Controls.Add(qrBox);

        // URL 面板（QR 码右侧）
        urlPanel = new Panel();
        urlPanel.Location = new Point(150, 96);
        urlPanel.Size = new Size(350, 120);
        urlPanel.BackColor = Color.FromArgb(20, 20, 40);
        Controls.Add(urlPanel);

        var waitLabel = new Label();
        waitLabel.Text = "扫码连接手机";
        waitLabel.Font = new Font("Microsoft YaHei", 12, FontStyle.Bold);
        waitLabel.ForeColor = Color.FromArgb(6, 182, 212);
        waitLabel.Location = new Point(10, 12);
        waitLabel.AutoSize = true;
        urlPanel.Controls.Add(waitLabel);

        urlLabel = new Label();
        urlLabel.Name = "urlLabel";
        urlLabel.Font = new Font("Consolas", 9);
        urlLabel.ForeColor = Color.FromArgb(200, 210, 230);
        urlLabel.Location = new Point(10, 42);
        ...
        openBtn.Font = new Font("Microsoft YaHei", 9);
        openBtn.Size = new Size(140, 30);
        openBtn.Location = new Point(10, 72);
        openBtn.BackColor = Color.FromArgb(79, 70, 229);
        ...
        logBox.Location = new Point(20, 224);
        logBox.Size = new Size(480, 134);
    ...
    void StartServer()
    {
        ...
        try
        {
            ...
            nodeProcess.OutputDataReceived += (s, e) => { if (e.Data != null) { var f = FilterOutput(e.Data); if (f != null) Invoke(new Action(() => Log(f))); CheckUrl(e.Data); } };
    ...
    void CheckUrl(string line)
    {
        // 捕获 Phone URL
        if (line.Contains("Phone URL:") || line.Contains("phone URL"))
        {
            int idx = line.IndexOf("http");
            if (idx >= 0)
            {
                phoneUrl = line.Substring(idx).Trim();
                Invoke(new Action(() =>
                {
                    urlLabel.Text = phoneUrl;
                    GenerateQrCode(phoneUrl);
                }));
            }
        }
    }
